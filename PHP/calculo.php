...
$real2=0;$real5=0;$real10=0;$real20=0;$real50=0;$real100=0;$real200=0;
function calcular_dinheiro($cent5=0,$cent10=0,$cent25=0,$cent50=0,$real1=0,$real2=0,$real5=0,$real10=0,$real20=0,$real50=0,$real100=0,$real200=0){
  if (empty($_POST["5_crs"]) and empty($_POST["10_crs"]) and empty($_POST["25_crs"]) and empty($_POST["50_crs"]) and empty($_POST["1_rs"]) and
   ...
   and empty($_POST["100_rs"]) and empty($_POST["200_rs"])){
      ...
      if(empty($_POST["100_rs"])){$_POST["100_rs"] = 0;} if(empty($_POST["200_rs"])){$_POST["200_rs"] = 0;}
      ...
      $real20 = $_POST["20_rs"]; $real50 = $_POST["50_rs"]; $real100 = $_POST["100_rs"]; $real200 = $_POST["200_rs"];
      $total = ($cent5 * 5 + $cent10 * 10 + $cent25 * 25 + $cent50 * 50 + $real1 * 100 + $real2 * 200
      + $real5 * 500 + $real10 * 1000 + $real20 * 2000 + $real50 * 5000 + $real100 * 10000 + $real200 * 20000) / 100;
